export const BRAND_ASSET_PATHS = {
  productionMacIconPng: "assets/prod/study-buddy-app-icon-1024.png",
  productionLinuxIconPng: "assets/prod/study-buddy-app-icon-1024.png",
  productionWindowsIconIco: "assets/prod/study-buddy-windows.ico",
  productionWebFaviconIco: "assets/prod/study-buddy-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/study-buddy-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/study-buddy-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/study-buddy-web-apple-touch-180.png",
