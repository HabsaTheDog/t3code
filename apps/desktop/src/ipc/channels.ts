...
export const SET_VIEWER_SURFACE_CHANNEL = "desktop:set-viewer-surface";
export const DESTROY_VIEWER_SURFACE_CHANNEL = "desktop:destroy-viewer-surface";
export const VIEWER_OPEN_TAB_CHANNEL = "desktop:viewer-open-tab";
...
export const SPEECH_GET_STATE_CHANNEL = "desktop:speech-get-state";
export const SPEECH_ENABLE_CHANNEL = "desktop:speech-enable";
export const SPEECH_REMOVE_CHANNEL = "desktop:speech-remove";
