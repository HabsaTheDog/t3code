...
const make = Effect.gen(function* () {
  ...
  const buildDelegatedWorkReviewPrompt = (input: {
    ...
    return [
      ...
      "At the very end of your answer, append exactly one hidden HTML comment named delegated-work-review-decisions.",
      "The comment must contain compact JSON in this exact shape:",
      '<!-- delegated-work-review-decisions {"decisions":[{"delegatedWorkId":"<id>","decision":"accepted|rejected|superseded","reason":"<short reason>","usedInFinalAnswer":true}]} -->',
      "Use accepted only when you verified the child output and used it as valid. Use rejected for wrong, failed, timed-out, or unusable output. Use superseded when you corrected or replaced the child output yourself.",
      "",
