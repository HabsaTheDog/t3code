import {
  ...
  ThreadDelegatedWorkUpsertedPayload as ContractsThreadDelegatedWorkUpsertedPayloadSchema,
  ThreadDeferredFinalizationUpsertedPayload as ContractsThreadDeferredFinalizationUpsertedPayloadSchema,
  ThreadDeferredFinalizationReleasedPayload as ContractsThreadDeferredFinalizationReleasedPayloadSchema,
  ThreadDelegatedWorkReviewedPayload as ContractsThreadDelegatedWorkReviewedPayloadSchema,
  ThreadDelegatedWorkReviewRequestedPayload as ContractsThreadDelegatedWorkReviewRequestedPayloadSchema,
...
export const ThreadDeferredFinalizationReleasedPayload =
  ContractsThreadDeferredFinalizationReleasedPayloadSchema;
export const ThreadDelegatedWorkReviewedPayload = ContractsThreadDelegatedWorkReviewedPayloadSchema;
export const ThreadDelegatedWorkReviewRequestedPayload =
  ContractsThreadDelegatedWorkReviewRequestedPayloadSchema;
