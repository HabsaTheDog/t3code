...
import Migration0033 from "./Migrations/033_ProjectionProjectsProjectKind.ts";
import Migration0034 from "./Migrations/034_ProjectionThreadDelegatedWork.ts";
import Migration0035 from "./Migrations/035_DelegatedWorkReviewAndDeferredFinalization.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionProjectsProjectKind", Migration0033],
  [34, "ProjectionThreadDelegatedWork", Migration0034],
  [35, "DelegatedWorkReviewAndDeferredFinalization", Migration0035],
] as const;
