...
const configuredPostHogProjectToken =
  repoEnv.VITE_POSTHOG_PROJECT_TOKEN?.trim() ||
...
export default defineConfig(() => {
  return {
    ...
    define: {
      ...
      "import.meta.env.VITE_POSTHOG_PROJECT_TOKEN": JSON.stringify(configuredPostHogProjectToken),
