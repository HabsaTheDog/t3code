...
import { selectRegularProjectsAcrossEnvironments, useStore } from "../store";
...
function useNewThreadState() {
  const projects = useStore(useShallow((store) => selectRegularProjectsAcrossEnvironments(store)));
